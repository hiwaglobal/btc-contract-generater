...
function generateBody() {
    var height = getrandomData(Name_1);
    var text1 = document.getElementById("height");
    text1.innerHTML=height;
    var weight = getrandomData(Name_2);
...
function generateHair() {
    ...
    var newColor = getrandomData(Name_3);
...
function generateEyes() {
    ...
    var newColor = getrandomData(Name_4);
...
function getrandomData(dataName){
	var t1Num = Math.floor(Math.random()*dataName.length);
